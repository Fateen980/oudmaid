...
<h3 class="alerts-title">Maid Agencies List</h3>
...
<figure class="item-thumb">
                    <a class="hover-effect" href="/agencyProfile/{{ $agency->id }}">
                      <img src="{{ asset('img/agency/' . $agency->path . '') }}" alt="">
                    </a>
                  </figure>
</div>
<div class="col-md-8">
<a class="hover-effect" href="/agencyProfile/{{ $agency->id }}"><h3>{{ $agency->name }}</h3></a>
<ul>
<li><span class="location"><i class="ti-location-pin"></i> Address :  {{ $agency->address }}</span></li>
<li><span class="location"><i class="ti-microphone"></i> Tel : {{ $agency->tel }}</span></li>
<li><span class="location"><i class="ti-email"></i> E-mail : {{ $agency->email }}</span></li>
<li><span class="location"><i class="ti-user"></i> Contact Person : {{ $agency->contactPerson }}</span></li>
</ul>
</div>
